...
function simple_php_captcha($config = array()) {
	...
	$bg_path ='/addons/captcha/backgrounds/';
	$font_path = '/addons/captcha/fonts/';
	...
	$captcha_config = array(
		...
		'characters' => '2345678923456789ABCDEFGHJKMNPRSTUVWXYZ',
		'min_font_size' => 30,
		'max_font_size' => 30,
		'color' => '#333',
		'angle_min' => 0,
	...
	$t = $captcha_config['code'];
	$captcha_config['code'] = strtolower($t);
	
	Session::set('captcha_config', serialize($captcha_config));
	return array(
...
if( isset($_GET['_CAPTCHA']) ) {
	include '/application/session.class.php';
	Session::init();

	$captcha_config = unserialize(Session::get('captcha_config'));
	...
	$text_pos_y = (($bg_height) + ($box_height/2)) / 2;
