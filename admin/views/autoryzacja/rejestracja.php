<div>
	<form class="form-horizontal" action="<?php url('autoryzacja/rejestruj');?>" method="POST">
		<h2 class="form-horizontal-heading center">Zarejestruj admina</h2>
		...
		<div class="form-group">
			...
			<div class="col-xs-12 col-md-3 col-sm-4"><input type="password" name="confirmpwd" id="confirmpwd" class="form-control" placeholder="Hasło"></div>
	 	</div>
